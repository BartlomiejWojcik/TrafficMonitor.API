...
using TrafficMonitor.API.Extensions;
...
namespace TrafficMonitor.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTrafficMonitorContext(Configuration.GetSection("DataSource:ConnectionString").Value)
                .AddScoped<ITrafficDetectorRepository, TrafficDetectorRepository>()
                .AddServices()
                .AddControllers();
        }
